...
$excel->getProperties()->setCreator('IAI SUMSEL')
             ...
             ->setTitle("Data Kursus $nama kelas $kelas")
             ->setSubject("Siswa")
...
$excel->setActiveSheetIndex(0)->setCellValue('A1', "DATA SISWA $nama $kelas"); // Set kolom A1 dengan tulisan "DATA SISWA"
...
$excel->setActiveSheetIndex(0)->setCellValue('C3', "ASAL INSTANSI"); // Set kolom C3 dengan tulisan "NAMA"
$excel->setActiveSheetIndex(0)->setCellValue('D3', "EMAIL");
$excel->setActiveSheetIndex(0)->setCellValue('E3', "HANDPHONE");
$excel->setActiveSheetIndex(0)->setCellValue('F3', "TTD");
...
foreach($member->result() as $u){ // Ambil semua data dari hasil eksekusi $sql
  ...
  $excel->setActiveSheetIndex(0)->setCellValue('B'.$numrow, $u->nama);
  $excel->setActiveSheetIndex(0)->setCellValue('C'.$numrow, $u->nama_institusi);
  $excel->setActiveSheetIndex(0)->setCellValue('D'.$numrow, $u->email);
  $excel->setActiveSheetIndex(0)->setCellValue('E'.$numrow, $u->handphone);
